...
function defaultConfig(): CryptoConfig {
  ...
  const tokens: CryptoPaymentToken[] = [
    { id: "btc-100000", enabled: false, chainId: 100000, symbol: "BTC", name: "Bitcoin", kind: "btc", address: "", decimals: 8, coingeckoId: "bitcoin" },
    { id: "eth-native-1", enabled: false, chainId: 1, symbol: "ETH", name: "Ether", kind: "native", address: "", decimals: 18, coingeckoId: "ethereum" },
    { id: "usdc-1", enabled: false, chainId: 1, symbol: "USDC", name: "USD Coin", kind: "erc20", address: "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48", decimals: 6, coingeckoId: "usd-coin" },
    { id: "usdt-1", enabled: false, chainId: 1, symbol: "USDT", name: "Tether USD", kind: "erc20", address: "0xdAC17F958D2ee523a2206206994597C13D831ec7", decimals: 6, coingeckoId: "tether" },
    { id: "dai-1", enabled: false, chainId: 1, symbol: "DAI", name: "Dai", kind: "erc20", address: "0x6B175474E89094C44Da98b954EedeAC495271d0F", decimals: 18, coingeckoId: "dai" },
    { id: "bnb-native-56", enabled: false, chainId: 56, symbol: "BNB", name: "BNB", kind: "native", address: "", decimals: 18, coingeckoId: "binancecoin" },
    { id: "usdt-56", enabled: false, chainId: 56, symbol: "USDT", name: "Tether USD (BEP20)", kind: "erc20", address: "0x55d398326f99059fF775485246999027B3197955", decimals: 18, coingeckoId: "tether" },
    { id: "usdc-56", enabled: false, chainId: 56, symbol: "USDC", name: "USD Coin (BEP20)", kind: "erc20", address: "0x8AC76a51cc950d9822D68b83fe1Ad97B32Cd580d", decimals: 18, coingeckoId: "usd-coin" },
    { id: "eth-native-8453", enabled: false, chainId: 8453, symbol: "ETH", name: "Ether (Base)", kind: "native", address: "", decimals: 18, coingeckoId: "ethereum" },
    { id: "usdc-8453", enabled: false, chainId: 8453, symbol: "USDC", name: "USD Coin (Base)", kind: "erc20", address: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", decimals: 6, coingeckoId: "usd-coin" },
  ];
