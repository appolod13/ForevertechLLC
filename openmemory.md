...
- Live status: Providers open an EventSource connection to /api/events (SSE ping/new_post) for the Live badge. This is not checkout; it’s a long-lived stream request that appears in DevTools.
