...
- Customize QR link field: /customize (ProductCustomizer) includes a “QR Link (optional)” input; if provided, it updates the back preview QR stamp target and is saved into cart item metadata.qrUrl so /checkout can prefill the QR Link field.
